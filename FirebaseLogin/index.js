...
import LoggedInTab from '../FirebaseLogin/screens/LoggedInTab/LoggedInTabNavigator';
...
export default class FirebaseLogin extends Component {
  ...
  render() {
    ...
    switch(this.state.currentScreen) {
      ...
      case 'LoggedInTabNavigator':
      screenToShow = <LoggedInTab change={this.changeScreen} />;
      break;
    }
